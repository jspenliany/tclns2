...
set opt(mtx_delay)	5.0				;#msg interval
set opt(wtx_delay)	20.2				;#msg interval

set opt(hello_start)	10.2				;# hello will start tx at 15.02
set opt(wired_start)	[expr $opt(hello_start) + 14.9]  ;# wired will start tx at 18.02		
set opt(comm_start)	[expr $opt(hello_start) + 7.9]
...
if {$i < $opt(nw)} {
    ...
    $udp_s($i) comm_interval 	$opt(wtx_delay)
