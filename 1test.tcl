...
for {set i 0} {$i < $opt(nm)} {incr i} {
	$ragent_($i) stimerSlocalperiod 	10.0
	$ragent_($i) stimerVlocalperiod 	10.0
	$ragent_($i) stimerVglobalperiod  	10.0
	$ragent_($i) stimerBlocalperiod  	10.0
}

$ns_ at 12 "$ragent_(0) vehiSelf_Bcast"
$ns_ at 12 "$ragent_(0) vehiLocal_Bcast"
$ns_ at 12 "$ragent_(0) vehiGlobal_Bcast"
$ns_ at 12 "$ragent_(0) baseLocal_Bcast"
$ns_ at 14 "$ragent_(0) sNode_runflag true"
$ns_ at 14 "$ragent_(0) stimerSlocalflag true"
$ns_ at 14 "$ragent_(0) stimerVlocalflag true"
$ns_ at 14 "$ragent_(0) stimerVglobalflag true"
$ns_ at 14 "$ragent_(0) stimerBlocalflag true"
